...
INPUT_FILE         = "complete_county_housing_buy_vs_rent.csv"
...
def main():
    ...
    df["monthly_gap"] = df["rent"] - df["effective_breakeven"]
    ...
    # --- Save results to CSV -------------------------------------------------
    output_cols = ["fips", "state", "county", "rent", "median_price",
    ...
    fig_map = px.choropleth(
        ...
        scope="usa",
        hover_data={"county": True, "state": True, "rent": True, "median_price": True,
